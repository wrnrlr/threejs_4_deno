...
function WebGLRenderer(parameters) {
  ...
  const _canvas = parameters.canvas !== undefined
    ...
    _antialias = parameters.antialias !== undefined ? parameters.antialias
    : false,
    _premultipliedAlpha = parameters.premultipliedAlpha !== undefined
      ? parameters.premultipliedAlpha
      : true,
    _preserveDrawingBuffer = parameters.preserveDrawingBuffer !== undefined
      ? parameters.preserveDrawingBuffer
      : false,
    _powerPreference = parameters.powerPreference !== undefined
  ...
  function renderObjects(renderList, scene, camera) {
    const overrideMaterial = scene.isScene === true
  ...
  function setProgram(camera, scene, material, object) {
    ...
    const environment = material.isMeshStandardMaterial
      ? scene.environment
      : null;
    const encoding = (_currentRenderTarget === null)
  ...
  function materialNeedsLights(material) {
    return material.isMeshLambertMaterial || material.isMeshToonMaterial ||
      material.isMeshPhongMaterial ||
  ...
  this.readRenderTargetPixels = function (
    ...
    if (
      renderTarget.isWebGLCubeRenderTarget && activeCubeFaceIndex !== undefined
    ) {
    ...
    if (framebuffer) {
      ...
      try {
        ...
        if (
          ...
          !(textureType === HalfFloatType && (capabilities.isWebGL2
