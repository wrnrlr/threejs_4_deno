...
class Ray {
  ...
  closestPointToPoint(point, target) {
    ...
    return target.copy(this.direction).multiplyScalar(directionDistance).add(
      this.origin,
    );
  }
  ...
  distanceSqToPoint(point) {
    const directionDistance = _vector.subVectors(point, this.origin).dot(
      this.direction,
    );
    ...
    _vector.copy(this.direction).multiplyScalar(directionDistance).add(
      this.origin,
    );
  ...
  distanceSqToSegment(v0, v1, optionalPointOnRay, optionalPointOnSegment) {
    ...
    if (optionalPointOnRay) {
      optionalPointOnRay.copy(this.direction).multiplyScalar(s0).add(
        this.origin,
      );
    }
