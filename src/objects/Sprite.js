...
function transformVertex(vertexPosition, mvPosition, center, scale, sin, cos) {
  ...
  if (sin !== undefined) {
    _rotatedPosition.x = (cos * _alignedPosition.x) -
      (sin * _alignedPosition.y);
    _rotatedPosition.y = (sin * _alignedPosition.x) +
      (cos * _alignedPosition.y);
  } else {
