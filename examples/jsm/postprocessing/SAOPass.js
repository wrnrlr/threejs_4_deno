...
var SAOPass = function (scene, camera, depthTexture, useNormals, resolution) {
  ...
  this.supportsDepthTextureExtension = (depthTexture !== undefined)
    ? depthTexture
    : false;
  ...
  this.saoMaterial.defines["NORMAL_TEXTURE"] = this.supportsNormalTexture
    ? 1
    : 0;
  this.saoMaterial.defines["PERSPECTIVE_CAMERA"] =
  ...
  this.vBlurMaterial.defines["DEPTH_PACKING"] =
    this.supportsDepthTextureExtension ? 0 : 1;
  this.vBlurMaterial.defines["PERSPECTIVE_CAMERA"] =
    this.camera.isPerspectiveCamera ? 1 : 0;
  ...
  this.hBlurMaterial.defines["DEPTH_PACKING"] =
    this.supportsDepthTextureExtension ? 0 : 1;
  this.hBlurMaterial.defines["PERSPECTIVE_CAMERA"] =
    this.camera.isPerspectiveCamera ? 1 : 0;
...
SAOPass.prototype = Object.assign(Object.create(Pass.prototype), {
  ...
  render: function (
    ...
    this.saoMaterial.uniforms["kernelRadius"].value =
      this.params.saoKernelRadius;
    this.saoMaterial.uniforms["minResolution"].value =
      this.params.saoMinResolution;
    this.saoMaterial.uniforms["cameraNear"].value = this.camera.near;
    this.saoMaterial.uniforms["cameraFar"].value = this.camera.far;
    // this.saoMaterial.uniforms['randomSeed'].value = Math.random();

    var depthCutoff = this.params.saoBlurDepthCutoff *
    ...
    if (this.params.output === 3) {
      if (this.supportsDepthTextureExtension) {
        ...
        this.depthCopy.uniforms["tDiffuse"].value =
          this.depthRenderTarget.texture;
