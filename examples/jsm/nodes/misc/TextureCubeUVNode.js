...
TextureCubeUVNode.prototype.bilinearCubeUV = function (
  ...
  this.colorSpaceTL = this.colorSpaceTL ||
    new ColorSpaceNode(new ExpressionNode("", "v4"));
  ...
  this.colorSpaceTR = this.colorSpaceTR ||
    new ColorSpaceNode(new ExpressionNode("", "v4"));
  ...
  this.colorSpaceBL = this.colorSpaceBL ||
    new ColorSpaceNode(new ExpressionNode("", "v4"));
  ...
  this.colorSpaceBR = this.colorSpaceBR ||
    new ColorSpaceNode(new ExpressionNode("", "v4"));
...
TextureCubeUVNode.prototype.generate = function (builder, output) {
  if (builder.isShader("fragment")) {
    ...
    console.warn(
      "THREE.TextureCubeUVNode is not compatible with " + builder.shader +
        " shader.",
    );
