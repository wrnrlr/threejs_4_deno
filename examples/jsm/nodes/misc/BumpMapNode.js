/// <reference types="./BumpMapNode.d.ts" />
/// <reference lib="dom" />
  ...
  if (builder.isShader("fragment")) {
    if (this.toNormalMap) {
      ...
      return builder.format(
        bumpToNormal + "( " + this.value.build(builder, "sampler2D") + ", " +
      ...
      var derivativeHeightCode = derivativeHeight + "( " +
        this.value.build(builder, "sampler2D") + ", " +
        this.value.uv.build(builder, "v2") + ", " +
        this.scale.build(builder, "f") + " )";

      return builder.format(
        perturbNormalArb + "( -" + this.position.build(builder, "v3") + ", " +
