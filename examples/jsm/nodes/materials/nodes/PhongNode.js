...
PhongNode.prototype.build = function (builder) {
  ...
  if (builder.isShader("vertex")) {
    ...
    var environment = this.environment
      ...
      : undefined;
    var environmentAlpha = this.environmentAlpha && this.environment
    ...
    output.push(
      "material.diffuseColor = " + (light ? "vec3( 1.0 )" : "diffuseColor") +
        ";",
    );
    ...
    if (environment) {
      ...
      if (environmentAlpha) {
        output.push(
          ...
          "outgoingLight = mix( outgoingLight, " + environment.result + ", " +
