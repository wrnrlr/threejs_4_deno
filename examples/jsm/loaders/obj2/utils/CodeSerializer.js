...
const CodeSerializer = {
  ...
  serializeClass: function (
    ...
    for (const name in targetPrototype.prototype) {
      ...
      if (name === "constructor") {
        if (!funcInstructions.isRemoveCode()) {
          constructorString = fullObjectName + " = " +
    ...
    for (const name in targetPrototype) {
      ...
      if (typeof objectPart === "function") {
        ...
        if (typeof (objectPart) === "string" || objectPart instanceof String) {
          ...
          console.log(
            'Omitting object "' + funcInstructions.getName() +
    ...
    if (isExtended) {
      objectString += fullObjectName + ".prototype = Object.create( " +
        basePrototypeName + ".prototype );\n";
    }

    objectString += fullObjectName + ".prototype.constructor = " +
      fullObjectName + ";\n";
    objectString += "\n\n";
