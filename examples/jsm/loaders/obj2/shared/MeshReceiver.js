/// <reference types="./MeshReceiver.d.ts" />
/// <reference lib="dom" />
/**
...
MeshReceiver.prototype = {
  ...
  _setCallbacks: function (onProgress, onMeshAlter) {
    ...
    if (
      onMeshAlter !== null && onMeshAlter !== undefined &&
  ...
  buildMeshes: function (meshPayload) {
    ...
    let useOrgMesh = true;
    const geometryType = meshPayload.geometryType === null
      ? 0
      : meshPayload.geometryType;
    ...
    if (meshes.length > 0) {
      ...
      progressMessage += ": Adding mesh(es) (" + meshNames.length + ": " +
        meshNames + ") from input mesh: " + meshName;
      progressMessage += " (" +
