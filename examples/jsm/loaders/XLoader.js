  ...
  var XLoader = function () {
    ...
    createClass(XLoader, [{
      ...
      value: function _setArgOption(_arg) {
        var _start = arguments.length > 1 && arguments[1] !== undefined
          ? arguments[1]
          : 0;
          ...
          if (find1 > 0 && findEnd > find1) {
            ...
            if (word.length > 0) {
              ...
              if (word.length >= 2) {
                ...
                _currentObject.name = word[0] +
                  this.Hierarchies.children.length;
              }
            } else {
            ...
            if (_currentObject.type === "Animation") {
              _currentObject.data = this._data.substr(
                findNext,
                findEnd - findNext,
              ).trim();
      ...
      value: function _mainloop() {
        ...
        if (
          ...
          this._currentObject.children.length > 0 || !this._currentObject.worked
        ) {
          setTimeout(function () {
            _this2._mainloop();
          }, 1);
      ...
      value: function _mainProc() {
        ...
        while (true) {
          if (!this._currentObject.worked) {
            switch (this._currentObject.type) {
              ...
              case "Animation":
                ...
                this._currentAnimeFrames.boneName = this._currentObject.data
                  .trim();
                break;
              case "AnimationKey":
          ...
          if (this._currentObject.children.length > 0) {
            ...
            if (this._currentObject.worked) {
              if (
                this._currentObject.parent && !this._currentObject.parent.parent
              ) {
                this._changeRoot();
              }
            }
      ...
      value: function _makePutBoneList(_RootName, _bones) {
        ...
        for (var frame in this.HieStack) {
          if (this.HieStack[frame].name === _RootName || putting) {
            ...
            b.pos = new Vector3().setFromMatrixPosition(b.FrameTransformMatrix)
              .toArray();
            b.rotq = new Quaternion().setFromRotationMatrix(
              b.FrameTransformMatrix,
            ).toArray();
            b.scl = new Vector3().setFromMatrixScale(b.FrameTransformMatrix)
              .toArray();
            if (
      ...
      value: function _initSkeleton(mesh, boneList, boneInverses) {
        ...
        for (i = 0, il = boneList.length; i < il; i++) {
          ...
          if (
            (gbone.parent !== -1) && (gbone.parent !== null) &&
      ...
      value: function _readAnimationKey() {
        ...
        for (var i = 0; i < data.length; i++) {
          ...
          if (nowKeyType != 4) {
            ...
            for (
              var mm = 0; mm < this._currentAnimeFrames.keyFrames.length; mm++
            ) {
              if (
