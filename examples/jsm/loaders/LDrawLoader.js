/// <reference types="./LDrawLoader.d.ts" />
/// <reference lib="dom" />
import {
  BufferAttribute,
  BufferGeometry,
  ...
  LDrawLoader.prototype = Object.assign(Object.create(Loader.prototype), {
    ...
    getMaterial: function (colourCode) {
      ...
      if (colourCode.startsWith("0x2")) {
        ...
        return this.parseColourMetaDirective(
          new LineParser(
            "Direct_Color_" + colour + " CODE -1 VALUE #" + colour + " EDGE #" +
              colour + "",
          ),
        );
      }
    ...
    parseColourMetaDirective: function (lineParser) {
      ...
      while (true) {
        ...
        switch (token.toUpperCase()) {
          ...
          default:
            throw 'LDrawLoader: Unknown token "' + token +
              '" while parsing material' + lineParser.getLineNumberString() +
              ".";
            break;
        }
      }
      ...
      switch (finishType) {
        ...
        case LDrawLoader.FINISH_TYPE_CHROME:
          ...
          material = new MeshStandardMaterial(
            { color: colour, roughness: 0, metalness: 1 },
          );
          break;
        ...
        case LDrawLoader.FINISH_TYPE_RUBBER:
          // Rubber finish
          material = new MeshStandardMaterial(
            { color: colour, roughness: 0.9, metalness: 0 },
          );
          canHaveEnvMap = false;
          break;
        ...
        case LDrawLoader.FINISH_TYPE_MATTE_METALLIC:
          ...
          material = new MeshStandardMaterial(
            { color: colour, roughness: 0.8, metalness: 0.4 },
          );
          break;
        ...
        case LDrawLoader.FINISH_TYPE_METAL:
          ...
          material = new MeshStandardMaterial(
            { color: colour, roughness: 0.2, metalness: 0.85 },
          );
          break;
      ...
      if (!edgeMaterial) {
        ...
        edgeMaterial.userData.conditionalEdgeMaterial.userData.canHaveEnvMap =
          false;
      }
    ...
    objectParse: function (text) {
      ...
      function parseColourCode(lineParser, forEdge) {
        ...
        if (!material) {
          throw 'LDrawLoader: Unknown colour code "' + colourCode +
            '" is used' + lineParser.getLineNumberString() +
      ...
      for (lineIndex = 0; lineIndex < numLines; lineIndex++) {
        ...
        switch (lineType) {
            ...
            if (meta) {
              switch (meta) {
                case "!LDRAW_ORG":
                  ...
                  if (
                    isRoot || scope.separateObjects && !isPrimitiveType(type)
                  ) {
                    currentParseScope.groupObject = new Group();

                    currentParseScope.groupObject.userData
                ...
                case "BFC":
                  ...
                  while (!lp.isAtTheEnd()) {
                    ...
                    switch (token) {
                      ...
                      default:
                        console.warn(
                          'THREE.LDrawLoader: BFC directive "' + token +
                            '" is unknown.',
                        );
          ...
          default:
            throw 'LDrawLoader: Unknown line type "' + lineType + '"' +
              lp.getLineNumberString() + ".";
            break;
        }
      }
    ...
    processObject: function (text, onProcessed, subobject, url) {
      ...
      function finalizeObject() {
        ...
        var isRoot = !parentParseScope.isFromParse;
        if (
          scope.separateObjects && !isPrimitiveType(parseScope.type) || isRoot
        ) {
      ...
      function loadSubobject(subobject) {
        ...
        switch (subobject.locationState) {
          ...
          case LDrawLoader.FILE_LOCATION_TRY_RELATIVE:
            subobjectURL = url.substring(0, url.lastIndexOf("/") + 1) +
              subobjectURL;
            newLocationState = subobject.locationState + 1;
            break;
          ...
          case LDrawLoader.FILE_LOCATION_NOT_FOUND:
            ...
            console.warn(
              'LDrawLoader: Subobject "' + subobject.originalFileName +
                '" could not be found.',
            );
