/// <reference types="./GLTFLoader.d.ts" />
/// <reference lib="dom" />
import {
  AnimationClip,
  Bone,
...
var GLTFLoader = (function () {
  ...
  GLTFMaterialsClearcoatExtension.prototype.getMaterialType = function (
    ...
    if (
      !materialDef.extensions || !materialDef.extensions[this.name]
    ) {
      return null;
    }
  ...
  function GLTFMaterialsPbrSpecularGlossinessExtension() {
    return {
      ...
      createMaterial: function (materialParams) {
        ...
        material.map = materialParams.map === undefined
          ? null
          : materialParams.map;
        ...
        material.aoMap = materialParams.aoMap === undefined
          ? null
        ...
        material.emissiveMap = materialParams.emissiveMap === undefined
          ? null
          : materialParams.emissiveMap;

        material.bumpMap = materialParams.bumpMap === undefined
          ? null
          : materialParams.bumpMap;
        material.bumpScale = 1;

        material.normalMap = materialParams.normalMap === undefined
          ? null
        ...
        material.specularMap = materialParams.specularMap === undefined
          ? null
          : materialParams.specularMap;
        material.specular = materialParams.specular;

        material.glossinessMap = materialParams.glossinessMap === undefined
          ? null
  ...
  function createPrimitiveKey(primitiveDef) {
    var dracoExtension = primitiveDef.extensions &&
  ...
  GLTFParser.prototype.loadAccessor = function (accessorIndex) {
    ...
    if (
      accessorDef.bufferView === undefined && accessorDef.sparse === undefined
    ) {
  ...
  GLTFParser.prototype.assignTexture = function (
    ...
    return this.getDependency("texture", mapDef.index).then(function (texture) {
      ...
      if (
        mapDef.texCoord !== undefined && mapDef.texCoord != 0 &&
  ...
  GLTFParser.prototype.assignFinalMaterial = function (mesh) {
    ...
    if (
      useVertexTangents || useVertexColors || useFlatShading || useSkinning ||
      useMorphTargets
    ) {
    ...
    if (
      material.aoMap && geometry.attributes.uv2 === undefined &&
  ...
  GLTFParser.prototype.loadMaterial = function (materialIndex) {
    ...
    if (materialExtensions[EXTENSIONS.KHR_MATERIALS_PBR_SPECULAR_GLOSSINESS]) {
      ...
      materialParams.metalness = metallicRoughness.metallicFactor !== undefined
        ? metallicRoughness.metallicFactor
        : 1.0;
      materialParams.roughness = metallicRoughness.roughnessFactor !== undefined
    ...
    return Promise.all(pending).then(function () {
      ...
      parser.associations.set(
        material,
        { type: "materials", index: materialIndex },
      );
