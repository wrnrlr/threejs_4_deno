    ...
    parse: function (buffer) {
      ...
      RGBE_RETURN_FAILURE = -1,
        ...
        fgets = function (buffer, lineLimit, consume) {
          ...
          while (
            (0 > (i = chunk.indexOf(NEWLINE))) && (len < lineLimit) &&
            (p < buffer.byteLength)
          ) {
            s += chunk;
            len += chunk.length;
        ...
        RGBE_ReadHeader = function (buffer) {
          var line,
            ...
            header = {
              ...
              gamma:
                1.0, /* image has already been gamma corrected with given gamma. defaults to 1.0 (no correction) */

              exposure:
                1.0, /* a value of 1.0 in an image corresponds to <exposure> watts/steradian/m^2. defaults to 1.0 */
