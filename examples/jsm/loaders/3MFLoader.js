  ...
  parse: function (data) {
    ...
    function loadDocument(data) {
      ...
      for (var i = 0; i < texturesPartNames.length; i++) {
        ...
        texturesParts[texturesPartName] = zip.file(texturesPartName)
          .asArrayBuffer();
      }
    ...
    function buildBasematerialsMeshes(
      ...
      for (var i = 0, l = triangleProperties.length; i < l; i++) {
        ...
        var pindex = (triangleProperty.p1 !== undefined)
          ? triangleProperty.p1
          : objectPindex;
    ...
    function buildVertexColorMesh(
      ...
      for (var i = 0, l = triangleProperties.length; i < l; i++) {
        ...
        var p1 = (triangleProperty.p1 !== undefined)
          ? triangleProperty.p1
          : objectData.pindex;
    ...
    function buildDefaultMesh(meshData) {
      ...
      var material = new MeshPhongMaterial(
        { color: 0xaaaaff, flatShading: true },
      );
    ...
    function analyzeObject(modelData, meshData, objectData) {
      ...
      for (var i = 0, l = triangleProperties.length; i < l; i++) {
        var triangleProperty = triangleProperties[i];
        var pid = (triangleProperty.pid !== undefined)
