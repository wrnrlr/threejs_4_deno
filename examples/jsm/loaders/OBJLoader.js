    ...
    parse: function (text) {
      ...
      for (var i = 0, l = state.objects.length; i < l; i++) {
        ...
        for (var mi = 0, miLen = materials.length; mi < miLen; mi++) {
          ...
          var materialHash = sourceMaterial.name + "_" + sourceMaterial.smooth +
            "_" + hasVertexColors;
          ...
          if (this.materials !== null) {
            ...
            if (
              isLine && material && !(material instanceof LineBasicMaterial)
            ) {
              ...
              isPoints && material && !(material instanceof PointsMaterial)
            ) {
