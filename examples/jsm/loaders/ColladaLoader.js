  ...
  parse: function (text, path) {
    ...
    function interpolate(key, prev, next, property) {
      ...
      key.value[property] =
        ((key.time - prev.time) *
          ...
          (next.time - prev.time)) + prev.value[property];
    }
    ...
    function buildSkin(data) {
      ...
      if (data.bindShapeMatrix) {
        build.bindMatrix = new Matrix4().fromArray(data.bindShapeMatrix)
          .transpose();
      } else {
      ...
      for (i = 0, l = jointSource.array.length; i < l; i++) {
        ...
        var boneInverse = new Matrix4().fromArray(
          inverseSource.array,
      ...
      function getTexture(textureObject) {
        ...
        if (image !== null) {
          ...
          if (loader !== undefined) {
            ...
            if (
              extra !== undefined && extra.technique !== undefined &&
                ...
                switch (key) {
                  case "POSITION":
                    ...
                    if (
                      ...
                      var count = (position.array.length - prevLength) /
                        position.stride;
    ...
    function setupKinematics() {
      ...
      if (
        kinematicsModelId === undefined || kinematicsSceneId === undefined
      ) {
        return;
      }
        ...
        setJointValue: function (jointIndex, value) {
          ...
          if (jointData) {
            ...
            if (value > joint.limits.max || value < joint.limits.min) {
              console.warn(
                "THREE.ColladaLoader: Joint " + jointIndex + " value " + value +
                  " outside of limits (min: " + joint.limits.min + ", max: " +
                  joint.limits.max + ").",
              );
    ...
    function buildBoneHierarchy(root, joints, boneData) {
      ...
      root.traverse(function (object) {
        if (object.isBone === true) {
          ...
          boneData.push(
            { bone: object, boneInverse: boneInverse, processed: false },
          );
        }
      });
    }
