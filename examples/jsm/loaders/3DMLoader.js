...
Rhino3dmLoader.prototype = Object.assign(Object.create(Loader.prototype), {
  ...
  _createMaterial: function (material) {
    ...
    if (
      _diffuseColor.r === 0 && _diffuseColor.g === 0 && _diffuseColor.b === 0
    ) {
      diffusecolor.r = 1;
      diffusecolor.g = 1;
      diffusecolor.b = 1;
      ...
      switch (obj.objectType) {
        ...
        default:
          if (attributes.hasOwnProperty("materialUUID")) {
            var rMaterial = materials.find((m) =>
              m.id === attributes.materialUUID
            );
    ...
    switch (obj.objectType) {
      ...
      case "PointSet":
        ...
        var material = new PointsMaterial(
          { color: color, sizeAttenuation: false, size: 2 },
        );
      ...
      if (this.workerPool.length < this.workerLimit) {
        ...
        worker.onmessage = function (e) {
          ...
          switch (message.type) {
            ...
            default:
              console.error(
                'THREE.Rhino3dmLoader: Unexpected message, "' + message.type +
                  '"',
              );
          }
        };
...
Rhino3dmLoader.Rhino3dmWorker = function () {
    ...
    for (var i = 0; i < doc.objects().count; i++) {
      ...
      if (object !== undefined) {
        if (object.attributes.materialIndex >= 0) {
          var mId =
            doc.materials().findIndex(object.attributes.materialIndex).id;
  ...
  function curveToPoints(curve, pointLimit) {
    ...
    for (var j = 0; j < pointCount; j++) {
      ...
      var ptS = prevTan[0] * prevTan[0] + prevTan[1] * prevTan[1] +
        prevTan[2] * prevTan[2];
