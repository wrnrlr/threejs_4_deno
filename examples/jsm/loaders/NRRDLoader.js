...
NRRDLoader.prototype = Object.assign(Object.create(Loader.prototype), {
  ...
  parse: function (data) {
    ...
    function parseHeader(header) {
      ...
      if (
        headerObject.encoding === "bz2" || headerObject.encoding === "bzip2"
      ) {
    ...
    function parseDataAsText(data, start, end) {
      ...
      var lengthOfTheResult = headerObject.sizes.reduce(
    ...
    if (headerObject.encoding === "gzip" || headerObject.encoding === "gz") {
      ...
      headerObject.encoding === "ascii" || headerObject.encoding === "text" ||
    ...
    volume.RASDimensions =
      (new Vector3(volume.xLength, volume.yLength, volume.zLength))
        .applyMatrix4(volume.matrix).round().toArray().map(Math.abs);
