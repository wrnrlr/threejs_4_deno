...
var Lensflare = function () {
  ...
  this.onBeforeRender = function (renderer, scene, camera) {
    ...
    screenPositionPixels.x = viewport.x +
      (positionScreen.x * halfViewportWidth) + halfViewportWidth - 8;
    screenPositionPixels.y = viewport.y +
      (positionScreen.y * halfViewportHeight) + halfViewportHeight - 8;
    ...
    if (validArea.containsPoint(screenPositionPixels)) {
      ...
      for (var i = 0, l = elements.length; i < l; i++) {
        ...
        uniforms["screenPosition"].value.x = positionScreen.x +
          vecX * element.distance;
        uniforms["screenPosition"].value.y = positionScreen.y +
          vecY * element.distance;
