...
var LightningStorm = function (stormParams) {
  ...
  stormParams.minHeight = stormParams.minHeight !== undefined
    ? stormParams.minHeight
    : 80.0;
  stormParams.maxHeight = stormParams.maxHeight !== undefined
    ? stormParams.maxHeight
    : 100.0;
  stormParams.maxSlope = stormParams.maxSlope !== undefined
    ? stormParams.maxSlope
    : 1.1;

  stormParams.maxLightnings = stormParams.maxLightnings !== undefined
    ? stormParams.maxLightnings
    : 3;

  stormParams.lightningMinPeriod = stormParams.lightningMinPeriod !== undefined
    ? stormParams.lightningMinPeriod
    : 3.0;
  stormParams.lightningMaxPeriod = stormParams.lightningMaxPeriod !== undefined
  ...
  this.lightningMaterial = stormParams.lightningMaterial !== undefined
  ...
  if (stormParams.onRayPosition !== undefined) {
    ...
    this.onRayPosition = function (source, dest) {
      ...
      source.set(
        ...
        1,
        stormParams.maxSlope * (2 * Math.random() - 1),
      ).multiplyScalar(height).add(dest);
    };
  }
