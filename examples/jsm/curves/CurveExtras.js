...
var Curves = (function () {
  ...
  GrannyKnot.prototype.getPoint = function (t, optionalTarget) {
    ...
    var x = -0.22 * Math.cos(t) - 1.28 * Math.sin(t) - 0.44 * Math.cos(3 * t) -
      0.78 * Math.sin(3 * t);
    var y = -0.1 * Math.cos(2 * t) - 0.27 * Math.sin(2 * t) +
      0.38 * Math.cos(4 * t) + 0.46 * Math.sin(4 * t);
  ...
  HeartCurve.prototype.getPoint = function (t, optionalTarget) {
    ...
    var y = 13 * Math.cos(t) - 5 * Math.cos(2 * t) - 2 * Math.cos(3 * t) -
      Math.cos(4 * t);
    var z = 0;
  ...
  DecoratedTorusKnot4b.prototype.getPoint = function (t, optionalTarget) {
    ...
    var x = Math.cos(2 * fi) *
      (1 + 0.45 * Math.cos(3 * fi) + 0.4 * Math.cos(9 * fi));
    var y = Math.sin(2 * fi) *
      (1 + 0.45 * Math.cos(3 * fi) + 0.4 * Math.cos(9 * fi));
  ...
  DecoratedTorusKnot5a.prototype.getPoint = function (t, optionalTarget) {
    ...
    var x = Math.cos(3 * fi) *
      (1 + 0.3 * Math.cos(5 * fi) + 0.5 * Math.cos(10 * fi));
    var y = Math.sin(3 * fi) *
      (1 + 0.3 * Math.cos(5 * fi) + 0.5 * Math.cos(10 * fi));
