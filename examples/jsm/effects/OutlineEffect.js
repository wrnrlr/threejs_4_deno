...
var OutlineEffect = function (renderer, parameters) {
  ...
  var defaultThickness = parameters.defaultThickness !== undefined
  ...
  var defaultAlpha = parameters.defaultAlpha !== undefined
    ? parameters.defaultAlpha
    : 1.0;
  var defaultKeepAlive = parameters.defaultKeepAlive !== undefined
  ...
  function isCompatible(object) {
    ...
    return (object.isMesh === true && object.material !== undefined &&
      hasNormals === true);
  }
  ...
  function updateOutlineMaterial(material, originalMaterial) {
    ...
    if (outlineParameters !== undefined) {
      if (originalMaterial.visible === false) {
        ...
        material.visible = (outlineParameters.visible !== undefined)
