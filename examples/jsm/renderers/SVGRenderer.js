...
var SVGRenderer = function () {
  ...
  this.setSize = function (width, height) {
    ...
    _svg.setAttribute(
      "viewBox",
      (-_svgWidthHalf) + " " + (-_svgHeightHalf) + " " + _svgWidth + " " +
        _svgHeight,
    );
  ...
  function renderSprite(v1, element, material) {
    ...
    var path = "M" + convert(v1.x - scaleX * 0.5) + "," +
      convert(v1.y - scaleY * 0.5) + "h" + convert(scaleX) + "v" +
      convert(scaleY) + "h" + convert(-scaleX) + "z";
    var style = "";

    if (material.isSpriteMaterial || material.isPointsMaterial) {
      style = "fill:" + material.color.getStyle() + ";fill-opacity:" +
        material.opacity;
    }
  ...
  function renderLine(v1, v2, element, material) {
    var path = "M" + convert(v1.positionScreen.x) + "," +
      convert(v1.positionScreen.y) + "L" + convert(v2.positionScreen.x) + "," +
      convert(v2.positionScreen.y);

    if (material.isLineBasicMaterial) {
      var style = "fill:none;stroke:" + material.color.getStyle() +
        ";stroke-opacity:" + material.opacity + ";stroke-width:" +
        material.linewidth + ";stroke-linecap:" + material.linecap;

      if (material.isLineDashedMaterial) {
        style = style + ";stroke-dasharray:" + material.dashSize + "," +
          material.gapSize;
      }
  ...
  function renderFace3(v1, v2, v3, element, material) {
    ...
    var path = "M" + convert(v1.positionScreen.x) + "," +
      convert(v1.positionScreen.y) + "L" + convert(v2.positionScreen.x) + "," +
      convert(v2.positionScreen.y) + "L" + convert(v3.positionScreen.x) + "," +
    ...
    if (material.isMeshBasicMaterial) {
      ...
      _centroid.copy(v1.positionWorld).add(v2.positionWorld).add(
        v3.positionWorld,
      ).divideScalar(3);
    ...
    if (material.wireframe) {
      style = "fill:none;stroke:" + _color.getStyle() + ";stroke-opacity:" +
        material.opacity + ";stroke-width:" + material.wireframeLinewidth +
        ";stroke-linecap:" + material.wireframeLinecap + ";stroke-linejoin:" +
