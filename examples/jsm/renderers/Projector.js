...
var Projector = function () {
  ...
  var RenderList = function () {
    ...
    function checkTriangleVisibility(v1, v2, v3) {
      if (
        v1.visible === true || v2.visible === true || v3.visible === true
      ) {
        return true;
      }
      ...
      if (object instanceof Mesh) {
        if (geometry instanceof BufferGeometry) {
          ...
          for (var f = 0, fl = faces.length; f < fl; f++) {
            ...
            if (
              renderList.checkTriangleVisibility(v1, v2, v3) === false
            ) {
              continue;
            }
            ...
            if (
              visible === false && (side === BackSide || side === DoubleSide)
            ) {
            ...
            for (
              var n = 0, nl = Math.min(faceVertexNormals.length, 3); n < nl; n++
            ) {
            ...
            _face.z =
              (v1.positionScreen.z + v2.positionScreen.z +
                v3.positionScreen.z) / 3;
            _face.renderOrder = object.renderOrder;
