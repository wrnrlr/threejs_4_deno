  ...
  })(
    {
      1: [function (require, module, exports) {
        ...
        function tinf_decode_symbol(e, t) {
          ...
          var n = 0, r = 0, s = 0, i = e.tag;
          do r = 2 * r + (1 & i),
            i >>>= 1,
            ++s,
            n += t.table[s],
            r -= t.table[s]; while (r >= 0);
            ...
            if (256 > r) e.dest[e.destLen++] = r;
              ...
              for (
                r -= 257,
                  ...
                  a = e.destLen - tinf_read_bits(e, dist_bits[i], dist_base[i]),
                  o = a;
                a + s > o;
                ++o
              ) {
      ...
      4: [function (require, module, exports) {
        ...
        DefaultEncoding.prototype.charToGlyphIndex = function (e) {
          var l = e.charCodeAt(0), r = this.font.glyphs;
          if (!r) return null;
          ...
          CffEncoding.prototype.charToGlyphIndex = function (e) {
            var l = e.charCodeAt(0), r = this.encoding[l];
              ...
              (util.checkArgument(
                ...
                this.tables = {
                  os2: {
                    ...
                    fsSelection: e.fsSelection ||
                      this.fsSelectionValues.REGULAR,
                  },
                }),
              this.supported = !0,
      ...
      7: [function (require, module, exports) {
        ...
        GlyphSet.prototype.get = function (e) {
          return "function" == typeof this.glyphs[e] &&
        ...
        function (require, module, exports) {
          ...
          function parseOpenTypeTableEntries(e, a) {
            for (var r = [], s = 12, t = 0; a > t; t += 1) {
              ...
              r.push(
                { tag: n, checksum: o, offset: p, length: l, compression: !1 },
              ), s += 16;
            }
            return r;
          }
          ...
          function loadSync(e) {
            var a = require("fs"), r = a.readFileSync(e);
      ...
      10: [function (require, module, exports) {
        ...
        exports.getByte = function (t, r) {
          ...
          exports.getFixed = function (t, r) {
            var e = t.getInt16(r, !1), s = t.getUint16(r + 2, !1);
            return e + s / 65535;
          },
        ...
        Parser.prototype.parseByte = function () {
          ...
          Parser.prototype.parseString = function (t) {
            var r = this.data, e = this.offset + this.relativeOffset, s = "";
          ...
          Parser.prototype.parseOffset16List = Parser.prototype
            .parseUShortList = function (t) {
          ...
          Parser.prototype.parseCoverage = function () {
            var t = this.offset + this.relativeOffset,
              r = this.parseUShort(),
              e = this.parseUShort();
            if (1 === r) return { format: 1, glyphs: this.parseUShortList(e) };
            if (2 === r) {
      ...
      11: [function (require, module, exports) {
        ...
        Path.prototype.moveTo = function (t, o) {
          ...
          Path.prototype.curveTo = Path.prototype.bezierCurveTo = function (
            ...
            this.commands.push(
              { type: "C", x1: t, y1: o, x2: e, y2: i, x: s, y: h },
            );
          },
          ...
          Path.prototype.toPathData = function (t) {
            ...
            for (var i = "", s = 0; s < this.commands.length; s += 1) {
              ...
              "M" === h.type ? i += "M" + e(h.x, h.y)
              : "L" === h.type ? i += "L" + e(h.x, h.y) : "C" === h.type
          ...
          Path.prototype.toSVG = function (t) {
            var o = '<path d="';
            return o += this.toPathData(t),
              o += '"',
              this.fill && "black" !== this.fill && (o += null === this.fill
                ? ' fill="none"'
                : ' fill="' + this.fill + '"'),
              this.stroke &&
              (o += ' stroke="' + this.stroke + '" stroke-width="' +
                this.strokeWidth + '"'),
              o += "/>";
          },
          exports.Path = Path;
      ...
      12: [function (require, module, exports) {
        ...
        Substitution.prototype = Layout,
          ...
          Substitution.prototype.getSingle = function (t, e, r) {
            var a = [], s = this.getLookupTable(e, r, t, 1);
            if (!s) return a;
            for (var o = s.subtables, u = 0; u < o.length; u++) {
              ...
              if (1 === n.substFormat) {
                ...
                var b = n.substitute;
                for (i = 0; i < g.length; i++) a.push({ sub: g[i], by: b[i] });
              }
            }
            return a;
          },
          Substitution.prototype.getAlternates = function (t, e, r) {
            var a = [], s = this.getLookupTable(e, r, t, 3);
            if (!s) return a;
            for (var o = s.subtables, u = 0; u < o.length; u++) {
              for (
                var i = o[u],
          ...
          Substitution.prototype.getLigatures = function (t, e, r) {
            var a = [], s = this.getLookupTable(e, r, t, 4);
            if (!s) return [];
            for (var o = s.subtables, u = 0; u < o.length; u++) {
              for (
                var i = o[u],
          ...
          Substitution.prototype.addSingle = function (t, e, r, a) {
            ...
            var u = e.sub, i = this.binSearch(o.coverage.glyphs, u);
            0 > i &&
            (i = -1 - i,
              o.coverage.glyphs.splice(i, 0, u),
              o.substitute.splice(i, 0, 0)), o.substitute[i] = e.by;
          },
          Substitution.prototype.addAlternate = function (t, e, r, a) {
            ...
            (i = -1 - i,
              o.coverage.glyphs.splice(i, 0, u),
              o.alternateSets.splice(i, 0, 0)), o.alternateSets[i] = e.by;
          },
          Substitution.prototype.addLigature = function (t, e, r, a) {
            r = r || "DFLT", a = a || "DFLT";
            var s = this.getLookupTable(r, a, t, 4, !0), o = s.subtables[0];
            o ||
            (o = {
              substFormat: 1,
              coverage: { format: 1, glyphs: [] },
      ...
      13: [function (require, module, exports) {
        ...
        function tableList(e, t, a) {
          var r = t.length, o = new Array(r + 1);
        ...
        function ScriptList(e) {
          Table.call(
            ...
            recordList("scriptRecord", e, function (e, t) {
              var a = e.script, r = a.defaultLangSys;
              return check.assert(
                !!r,
                "Unable to write GSUB: script " + e.tag +
      ...
      14: [
        function (require, module, exports) {
          ...
          function parseCFFIndex(e, t, a) {
            var r, n, s, i = [], o = [], h = parse.getCard16(e, t);
            if (0 !== h) {
          ...
          function entriesToObject(e) {
            for (var t = {}, a = 0; a < e.length; a += 1) {
              ...
              if (
                r = 1 === s.length ? s[0] : s, t.hasOwnProperty(n)
              ) {
          ...
          function parseCFFDict(e, t, a) {
            t = void 0 !== t ? t : 0;
            var r = new parse.Parser(e, t), n = [], s = [];
          ...
          function parseCFFHeader(e, t) {
            var a = {};
            return a.formatMajor = parse.getCard8(e, t),
          ...
          function parseCFFCharset(e, t, a, r) {
            ...
            a -= 1;
            var h = [".notdef"], f = o.parseCard8();
            if (0 === f) {
              for (n = 0; a > n; n += 1) {s = o.parseSID(),
                  h.push(getCFFString(r, s));}
            } else if (1 === f) {for (; h.length <= a;) {
                for (
                  s = o.parseSID(), i = o.parseCard8(), n = 0; i >= n; n += 1
                ) {
              ...
              for (; h.length <= a;) {for (
                  s = o.parseSID(), i = o.parseCard16(), n = 0; i >= n; n += 1
                ) {
                  h.push(getCFFString(r, s)), s += 1;
                }}
            }
          ...
          function parseCFFEncoding(e, t, a) {
            var r, n, s = {}, i = new parse.Parser(e, t), o = i.parseCard8();
            if (0 === o) {
              var h = i.parseCard8();
          ...
          function parseCFFCharstring(e, t, a) {
            ...
            function s(a) {
              for (
                var y, b, C, T, F, I, D, x, k, S, E, O, R = 0; R < a.length;
              ) {
                var M = a[R];
                switch (R += 1, M) {
                  case 1:
                    ...
                    switch (M = a[R], R += 1, M) {
                      ...
                      case 37:
                        i = v + u.shift(),
                          ...
                          E = k + u.shift(),
                          O = S + u.shift(),
                          Math.abs(E - v) > Math.abs(O - m) ? v = E + u.shift()
                          : m = O + u.shift(),
                          p.curveTo(i, o, h, f, D, x),
                          p.curveTo(k, S, E, O, v, m);
                        break;
                  ...
                  default:
                    32 > M
                      ...
                      ? u.push(M - 139)
                      : 251 > M
                      ? (y = a[R], R += 1, u.push(256 * (M - 247) + y + 108))
                      : 255 > M
                      ? (y = a[R], R += 1, u.push(256 * -(M - 251) - y - 108))
                      : (y = a[R],
                        b = a[R + 1],
                        C = a[R + 2],
                        T = a[R + 3],
          ...
          function encodeString(e, t) {
            ...
            return r >= 0 && (a = r),
              r = t.indexOf(e),
              r >= 0 ? a = r + encoding.cffStandardStrings.length
              : (a = encoding.cffStandardStrings.length + t.length, t.push(e)),
              a;
          }
          function makeHeader() {
          ...
          function makeStringIndex(e) {
            ...
            for (var a = 0; a < e.length; a += 1) {
              t.strings.push(
                { name: "string_" + a, type: "STRING", value: e[a] },
              );
            }
            return t;
          }
          ...
          function makeCharStringsIndex(e) {
            for (
              ...
              t.charStrings.push(
                { name: r.name, type: "CHARSTRING", value: n },
              );
            }
            return t;
          }
          ...
          function makeCFFTable(e, t) {
            ...
            var u = r.header.sizeOf() + r.nameIndex.sizeOf() +
              r.topDictIndex.sizeOf() + r.stringIndex.sizeOf() +
      ...
      15: [function (require, module, exports) {
        ...
        function parseCmapTable(e, a) {
          ...
          t.version = parse.getUShort(e, a),
            check.argument(0 === t.version, "cmap table version should be 0."),
          ...
          if (
            t.format = l.parseUShort(), 12 === t.format
          ) {
        ...
        function makeCmapTable(e) {
          ...
          for (r.segments = [], a = 0; a < e.length; a += 1) {
            for (
              var t = e.get(a), n = 0; n < t.unicodes.length; n += 1
            ) {
          ...
          s = r.segments.length,
            r.segCountX2 = 2 * s,
            r.searchRange = 2 *
              Math.pow(2, Math.floor(Math.log(s) / Math.log(2))),
            r.entrySelector = Math.log(r.searchRange / 2) / Math.log(2),
            r.rangeShift = r.segCountX2 - r.searchRange;
          var o = [], l = [], p = [], g = [], m = [];
          for (a = 0; s > a; a += 1) {
            var u = r.segments[a];
            o = o.concat({ name: "end_" + a, type: "USHORT", value: u.end }),
              l = l.concat(
                { name: "start_" + a, type: "USHORT", value: u.start },
              ),
              p = p.concat(
                { name: "idDelta_" + a, type: "SHORT", value: u.delta },
              ),
              g = g.concat(
                { name: "idRangeOffset_" + a, type: "USHORT", value: u.offset },
              ),
              void 0 !== u.glyphId &&
              (m = m.concat(
                { name: "glyph_" + a, type: "USHORT", value: u.glyphId },
              ));
          }
          return r.fields = r.fields.concat(o),
            ...
            r.length = 14 + 2 * o.length + 2 + 2 * l.length + 2 * p.length +
      ...
      16: [function (require, module, exports) {
        ...
        function parseFvarAxis(e, a, r) {
          var n = {}, t = new parse.Parser(e, a);
          return n.tag = t.parseTag(),
        ...
        function parseFvarTable(e, a, r) {
          var n = new parse.Parser(e, a), t = n.parseULong();
      ...
      17: [function (require, module, exports) {
        ...
        function parseGlyph(e, r, t) {
          ...
          if (e.numberOfContours > 0) {
            ...
            for (
              e.instructionLength = o.parseUShort(), e.instructions = [], s = 0;
        ...
        function getPath(e) {
          ...
          for (var t = getContours(e), o = 0; o < t.length; o += 1) {
            ...
            p.onCurve
              ? (a = null, n = !0)
              : (p = i.onCurve ? i : { x: (p.x + i.x) / 2, y: (p.y + i.y) / 2 },
                a = p,
                n = !1), r.moveTo(p.x, p.y);
            ...
            p !== i &&
              (a ? r.quadraticCurveTo(a.x, a.y, p.x, p.y) : r.lineTo(p.x, p.y));
          }
        ...
        function parseGlyfTable(e, r, t, o) {
          ...
          for (a = 0; a < t.length - 1; a += 1) {
            ...
            s !== p
              ? n.push(
                a,
                glyphset.ttfGlyphLoader(o, a, parseGlyph, e, r + s, buildPath),
              )
      ...
      18: [function (require, module, exports) {
        ...
        function parseTaggedListTable(r, e) {
          for (
            var a = new parse.Parser(r, e), s = a.parseUShort(), t = [], o = 0;
            s > o;
            o++
          ) {
        ...
        function parseClassDefTable(r, e) {
          var a = new parse.Parser(r, e), s = a.parseUShort();
          if (1 === s) {
            var t = a.parseUShort(),
              o = a.parseUShort(),
          ...
          if (2 === s) {
            for (
              var n = a.parseUShort(), f = [], i = [], h = [], S = 0; n > S; S++
            ) {
              f[S] = a.parseUShort(),
                i[S] = a.parseUShort(),
                h[S] = a.parseUShort();
        ...
        function parseGposTable(r, e, a) {
          var s = new parse.Parser(r, e), t = s.parseFixed();
          ...
          for (
            ...
            2 !== h.lookupType || a.getGposKerningValue ||
      ...
      19: [function (require, module, exports) {
        ...
        function parseGsubTable(e, t) {
          t = t || 0;
          var s = new Parser(e, t), r = s.parseVersion();
      ...
      20: [function (require, module, exports) {
        ...
        function parseHeadTable(e, a) {
          var t = {}, r = new parse.Parser(e, a);
          return t.version = r.parseVersion(),
        ...
        function makeHeadTable(e) {
          var a = Math.round((new Date()).getTime() / 1e3) + 2082844800, t = a;
          return e.createdTimestamp && (t = e.createdTimestamp + 2082844800),
            new table.Table(
              "head",
              [
      ...
      21: [function (require, module, exports) {
        ...
        function parseHheaTable(e, a) {
          var r = {}, t = new parse.Parser(e, a);
          return r.version = t.parseVersion(),
      ...
      22: [function (require, module, exports) {
        ...
        function makeHmtxTable(e) {
          for (
            var a = new table.Table("hmtx", []), r = 0; r < e.length; r += 1
          ) {
            var t = e.get(r),
              s = t.advanceWidth || 0,
              i = t.leftSideBearing || 0;
            a.fields.push(
              { name: "advanceWidth_" + r, type: "USHORT", value: s },
            ),
              a.fields.push(
                { name: "leftSideBearing_" + r, type: "SHORT", value: i },
              );
          }
          return a;
        }
      ...
      23: [function (require, module, exports) {
        ...
        function parseKernTable(r, e) {
          var a = {}, s = new parse.Parser(r, e), p = s.parseUShort();
        ...
        function makeLtagTable(e) {
          for (
            ...
            0 > s && (s = r.length, r += e[n]),
              a.fields.push(
                { name: "offset " + n, type: "USHORT", value: t + s },
              ),
              a.fields.push(
                { name: "length " + n, type: "USHORT", value: e[n].length },
              );
          }
          return a.fields.push(
            { name: "stringPool", type: "CHARARRAY", value: r },
          ),
            a;
        }
        function parseLtagTable(e, a) {
          var r = new parse.Parser(e, a), t = r.parseULong();
      ...
      26: [function (require, module, exports) {
        ...
        function parseMaxpTable(e, a) {
          var r = {}, s = new parse.Parser(e, a);
          return r.version = s.parseVersion(),
        ...
        function makeMetaTable(e) {
          ...
          for (var n in e) {
            ...
            r += e[n],
              ...
              s.fields.push(
                { name: "offset " + n, type: "ULONG", value: t + p },
              ),
              s.fields.push(
                { name: "length " + n, type: "ULONG", value: e[n].length },
              );
          }
      ...
      28: [function (require, module, exports) {
        ...
        function makeNameTable(e, a) {
          var r, n = [], t = {}, s = reverseDict(nameTableNames);
          for (var m in e) {
            var i = s[m];
            if (
              void 0 === i && (i = m), r = parseInt(i), isNaN(r)
            ) {
              throw new Error(
                'Name table entry "' + m +
          ...
          u.sort(function (e, a) {
            return e.platformID - a.platformID || e.encodingID - a.encodingID ||
              e.languageID - a.languageID || e.nameID - a.nameID;
          });
          for (
            var U = new table.Table(
                "name",
                [
            ...
            U.fields.push({ name: "record_" + I, type: "RECORD", value: u[I] });
          }
          return U.fields.push({ name: "strings", type: "LITERAL", value: l }),
            U;
        }
        var types = require("../types"),
          decode = types.decode,
      ...
      29: [function (require, module, exports) {
        ...
        function parseOS2Table(e, n) {
          ...
          return a.ulUnicodeRange1 = i.parseULong(),
      ...
      30: [function (require, module, exports) {
        ...
        function parsePostTable(e, a) {
          var r, n = {}, s = new parse.Parser(e, a);
          switch (
      ...
      31: [
        function (require, module, exports) {
          ...
          function computeCheckSum(e) {
            ...
            for (var a = 0, n = 0; n < e.length; n += 4) {a += (e[n] << 24) +
                (e[n + 1] << 16) + (e[n + 2] << 8) + e[n + 3];}
          ...
          function makeSfntTable(e) {
            ...
            for (var s = 0; s < e.length; s += 1) {
              ...
              for (
                t.push(
                  { name: m.tag + " Table Record", type: "RECORD", value: m },
                ),
                  r.push(
                    { name: l.tableName + " table", type: "RECORD", value: l },
                  ),
                  i += u,
                  check.argument(
                    !isNaN(i),
          ...
          function fontToSfntTable(e) {
              ...
              T = os2.make(
                {
                  ...
                  sCapHeight:
                    metricsForChar(e, "HIKLEFJMNTZBDPRAGOQSUVWXY", x).yMax,
            ...
            var w = [],
              ...
              F = e.metas && Object.keys(e.metas).length > 0
                ? meta.make(e.metas) : void 0,
              G = [b, M, S, T, B, R, L, A, k];
            U && G.push(U),
      ...
      32: [function (require, module, exports) {
        ...
        encode.BYTE = function (e) {
          ...
          encode.SHORT = function (e) {
            return e >= LIMIT16 && (e = -(2 * LIMIT16 - e)),
              [e >> 8 & 255, 255 & e];
          },
          ...
          encode.LONG = function (e) {
            return e >= LIMIT32 && (e = -(2 * LIMIT32 - e)),
          ...
          encode.REAL = function (e) {
            ...
            i += 1 & i.length ? "f" : "ff";
            var f = [30];
            for (c = 0, r = i.length; r > c; c += 2) {f.push(
                parseInt(i.substr(c, 2), 16),
              );}
            return f;
          },
          ...
          decode.UTF8 = function (e, n, t) {
            for (var o = [], c = t, r = 0; c > r; r++, n += 1) {o[r] = e
                .getUint8(n);}
        ...
        var macEncodingTableCache = "function" == typeof WeakMap &&
            new WeakMap(),
          ...
          getMacEncodingTable = function (e) {
            ...
            if (void 0 === c) return void 0;
            for (var r = {}, i = 0; i < c.length; i++) {r[c.charCodeAt(i)] = i +
                128;}
        ...
        encode.MACSTRING = function (e, n) {
          ...
          encode.DICT = function (e) {
            for (
              var n = [], t = Object.keys(e), o = t.length, c = 0; o > c; c += 1
            ) {
        ...
        encode.CHARSTRING = function (e) {
          ...
          encode.TABLE = function (e) {
            var n, t = [], o = e.fields.length, c = [], r = [];
            for (n = 0; o > n; n += 1) {
              var i = e.fields[n], a = encode[i.type];
              check.argument(
                void 0 !== a,
                "No encoding function for field type " + i.type + " (" +
                  i.name + ")",
              );
              var f = e[i.name];
              void 0 === f && (f = i.value);
          ...
          sizeOf.TABLE = function (e) {
            for (var n = 0, t = e.fields.length, o = 0; t > o; o += 1) {
              ...
              check.argument(
                void 0 !== r,
                "No sizeOf function for field type " + c.type + " (" + c.name +
                  ")",
              );
              var i = e[c.name];
              void 0 === i && (i = c.value),
