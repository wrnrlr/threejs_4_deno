...
!function (t, e) {
  ...
  return function (t) {
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var r = n(0), i = n(4), o = n(15), a = n(7);
    function s(t) {
      return r.isString(t.LABEL) && "" !== t.LABEL;
    }
    function u(t) {
      return r.isObject(t) && t.hasOwnProperty("tokenName") &&
    ...
    e.END_OF_FILE = u.createTokenInstance(
      ...
      e.DEFAULT_RULE_CONFIG = Object.freeze(
        { recoveryValueFunc: function () {}, resyncEnabled: !0 },
      ),
      function (t) {
    ...
    var _ = function () {
      ...
      return t.performSelfAnalysis = function (t) {
        ...
        t.prototype.performSelfAnalysis = function () {
          ...
          var r = o.classNameFromInstance(this), i = this.gastProductionsCache;
    ...
    e.functionName = a,
      e.defineNameProp = function (t, e) {
        ...
        return !(!r.isUndefined(n) && !n.configurable ||
          (Object.defineProperty(
            t,
            o,
            { enumerable: !1, configurable: !0, writable: !1, value: e },
          ),
            0));
      };
    var s = function () {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    var o = n(0), a = n(1), s = n(5), u = n(2);
    e.isSequenceProd = function (t) {
      return t instanceof a.Flat || t instanceof a.Option ||
        t instanceof a.Repetition || t instanceof a.RepetitionMandatory ||
        t instanceof a.RepetitionMandatoryWithSeparator ||
        t instanceof a.RepetitionWithSeparator || t instanceof a.Terminal ||
        t instanceof a.Rule;
    },
      e.isOptionalProd = function t(e, n) {
        return void 0 === n && (n = []),
          !!(e instanceof a.Option || e instanceof a.Repetition ||
      ...
      e.getProductionDslName = function (t) {
        ...
        if (t instanceof a.RepetitionWithSeparator) {
          return "MANY_SEP";
        }
    ...
    e.defaultParserErrorProvider = {
      buildMismatchTokenMessage: function (t) {
        ...
        return "Expecting " + (r.hasTokenLabel(e)
          ? "--\x3e " + r.tokenLabel(e) + " <--"
      ...
      e.defaultGrammarResolverErrorProvider = {
        buildRuleNotFoundError: function (t, e) {
          return "Invalid grammar, reference to a rule which is not defined: ->" +
      ...
      e.defaultGrammarValidatorErrorProvider = {
          ...
          var n,
            ...
            h = "->" + p + "<- with numerical suffix: ->" + c +
              "<-\n                  " + (l
                ? "and argument: ->" + l + "<-"
                : "") +
              "\n                  appears more than once (" + e.length +
              " times) in the top level rule: ->" + i +
              "<-.\n                  " + (0 === c
                ? "Also note that numerical suffix 0 means " + p +
                  " without any suffix."
                : "") +
        ...
        buildInvalidNestedRuleNameError: function (t, e) {
          return "Invalid nested rule name: ->" + e.name +
            "<- inside rule: ->" + t.name +
        ...
        buildDuplicateNestedRuleNameError: function (t, e) {
          return "Duplicate nested rule name: ->" + o.first(e).name +
            "<- inside rule: ->" + t.name +
        ...
        buildAlternationAmbiguityError: function (t) {
          var e = o.map(t.prefixPath, function (t) {
            ...
            n = 0 === t.alternation.idx ? "" : t.alternation.idx,
            i = "Ambiguous alternatives: <" + t.ambiguityIndices.join(" ,") +
              "> in <OR" + n + "> inside <" + t.topLevelRule.name +
              "> Rule,\n<" + e +
              "> may appears as a prefix path in all these alternatives.\n",
        ...
        buildEmptyRepetitionError: function (t) {
          ...
          return 0 !== t.repetition.idx && (e += t.repetition.idx),
            "The repetition <" + e + "> within Rule <" + t.topLevelRule.name +
            "> can never consume any tokens.\nThis could lead to an infinite loop.";
        },
        buildTokenNameError: function (t) {
          return "Invalid Grammar Token name: ->" + r.tokenName(t.tokenType) +
            "<- it must match the pattern: ->" + t.expectedPattern.toString() +
            "<-";
        },
        buildEmptyAlternationError: function (t) {
          return "Ambiguous empty alternative: <" + (t.emptyChoiceIdx + 1) +
            "> in <OR" + t.alternation.idx + "> inside <" +
            t.topLevelRule.name +
            "> Rule.\nOnly the last alternative may be an empty alternative.";
        },
        buildTooManyAlternativesError: function (t) {
          return "An Alternation cannot have more than 256 alternatives:\n<OR" +
            t.alternation.idx + "> inside <" + t.topLevelRule.name +
            "> Rule.\n has " + (t.alternation.definition.length + 1) +
            " alternatives.";
        },
        ...
        buildInvalidRuleNameError: function (t) {
          return "Invalid grammar rule name: ->" + t.topLevelRule.name +
            "<- it must match the pattern: ->" + t.expectedPattern.toString() +
            "<-";
        },
              ...
              r.push(
                {
                  message: o,
                  type:
                    s.ParserDefinitionErrorType.CONFLICT_TOKENS_RULES_NAMESPACE,
                  ruleName: e,
                },
              );
            }
    ...
    function T(t, n) {
      var r = [], i = t.name;
      return i.match(e.validTermsPattern) ||
        r.push(
          {
            message: n.buildInvalidRuleNameError(
              { topLevelRule: t, expectedPattern: e.validTermsPattern },
            ),
    ...
    function v(t, n, r) {
      var i, o = [];
      return n.name.match(e.validNestedRuleName) ||
    ...
    function g(t, n) {
      var r = [];
      return c.tokenName(t).match(e.validTermsPattern) ||
        r.push(
          {
            message: n.buildTokenNameError(
              { tokenType: t, expectedPattern: e.validTermsPattern },
            ),
        ...
        i.push(
          {
            message: n.buildLeftRecursionError(
              { topLevelRule: t, leftRecursionPath: r },
            ),
    ...
    e.OccurrenceValidationCollector = y,
      ...
      e.validateRuleIsOverridden = function (t, e, n) {
        ...
        return o.contains(e, t) ||
          (r = "Invalid rule override, rule: ->" + t +
            "<- cannot be overridden in the grammar: ->" + n +
            ...
            return o.isEmpty(a)
              ? {
                message: e.buildEmptyAlternationError(
                  { topLevelRule: t, alternation: r, emptyChoiceIdx: i },
                ),
    ...
    function S(t, e, n, r) {
      var i = new N();
      t.accept(i);
      var c = i.alternations, l = n[t.name];
      ...
      return a.forEach(o, function (t) {
        var u = t.idx,
          ...
          h = a.map(l, function (t) {
            var i = [t.idx + 1, u + 1], o = 0 === e.idx ? "" : e.idx;
            return {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    var o, a = n(0), s = n(13), u = n(14), c = n(7), p = n(1), l = n(5);
    !function (t) {
      t[t.OPTION = 0] = "OPTION",
    ...
    var h = function (t) {
        ...
        return i(e, t),
          ...
          e.prototype.checkIsTarget = function (t, e, n, r) {
            return t.idx === this.targetOccurrence &&
              this.targetProdType === e && (this.restDef = n.concat(r), !0);
          },
      ...
      f = function (t) {
        ...
        return i(e, t),
          e.prototype.checkIsTarget = function (t, e) {
            t.idx === this.targetOccurrence && this.targetProdType === e &&
      ...
      for (
        ...
        for (var h = 0; h < l.length; h++) {
          for (var f = l[h], d = n(l, h), E = 0; E < f.length; E++) {
            var m = f[E].partialPath, T = f[E].suffixDef;
    ...
    function m(t, e, n, r) {
      var i = new f(t, n);
      e.accept(i);
      var o = i.result, a = new h(e, t, n).startWalking();
      return d(
      ...
      p = function (t) {
        ...
        return i(e, t),
          e.prototype.startWalking = function () {
            ...
            return this.ruleStack = a.cloneArr(this.path.ruleStack).reverse(),
              this.occurrenceStack = a.cloneArr(this.path.occurrenceStack)
                .reverse(),
              this.ruleStack.pop(),
      ...
      return i(e, t),
        e.prototype.walkTerminal = function (t, e, n) {
          if (
            ...
            t.idx === this.nextTerminalOccurrence && !this.found
          ) {
            var r = e.concat(n), i = new c.Flat({ definition: r });
          ...
          if (u instanceof c.Option) i = s(u.definition);
            ...
            if (u instanceof c.RepetitionWithSeparator) {
              ...
              if (u instanceof c.Alternation) {
                return a.forEach(u.definition, function (t) {
                  i = s(t.definition);
                }),
                  i;
              }
      ...
      e.nextPossibleTokensAfter = function (t, e, n, r) {
        ...
        for (
          ...
          if ("EXIT_ALTERNATIVE" !== h) {
            var f = h.def, d = h.idx, E = h.ruleStack, m = h.occurrenceStack;
            if (!a.isEmpty(f)) {
              var T = f[0];
              if ("EXIT_NONE_TERMINAL" === T) {
                ...
                var O = new c.Repetition(
                  { definition: T.definition, idx: T.idx },
                );
                v = {
                  idx: d,
                ...
                O = new c.Repetition(
                  { definition: [S].concat(T.definition), idx: T.idx },
                ),
                  v = {
                    idx: d,
                    def: T.definition.concat([O], a.drop(f)),
                ...
                if (!(T instanceof c.Rule)) {throw Error(
          ...
          void 0 === e && (e = []),
            r.forEach(t.definition, function (o, a) {
              ...
              if (o instanceof i.NonTerminal) n.walkProdRef(o, s, e);
                ...
                n.walkManySep(o, s, e);
              } else if (o instanceof i.Repetition) {
                n.walkMany(o, s, e);
              } else {
    ...
    var u = function () {
      function t(t, e) {
        ...
        } else if (/onlyStart/i.test(this.config.positionTracking)) {this
            .createTokenInstance = this.createStartOnlyToken;} else {
      ...
      return t.prototype.tokenize = function (t, e) {
        ...
        t.prototype.tokenizeInternal = function (t, e) {
          ...
          for (w.call(this, e); v < T;) {
            u = null;
            var U = y.charCodeAt(v), G = b(U), B = G.length;
            for (n = 0; n < B; n++) {
              var K = (F = G[n]).pattern;
              if (
                !1 !== (Z = F.short)
            ...
            if (null !== u) {
              ...
              f = v - X,
                d = this.config.errorMessageProvider
                  .buildUnexpectedCharactersMessage(y, X, f, z, q),
                A.push(
                  { offset: X, line: z, column: q, length: f, message: d },
                );
            }
          }
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    var o = n(0), a = n(4), s = n(9), u = n(1), c = n(5);
      ...
      return i(e, t),
        e.prototype.collectNamedDSLMethod = function (t, e, n) {
          if (!o.isUndefined(t.name)) {
            var r = void 0;
            if (
              t instanceof u.Option || t instanceof u.Repetition ||
              t instanceof u.RepetitionMandatory || t instanceof u.Alternation
            ) {
      ...
      void 0 === (o = "function" == typeof (r = function () {
            ...
            t.prototype.saveState = function () {
              ...
              t.prototype.disjunction = function () {
                var t = [];
                for (
                  t.push(this.alternative()); "|" === this.peekChar();
                ) {
              ...
              t.prototype.atom = function () {
                ...
                return void 0 === t && this.isPatternCharacter() &&
              ...
              t.prototype.characterClass = function () {
                ...
                for (
                  this.consumeChar("["),
                    "^" === this.peekChar(0) && (this.consumeChar("^"), e = !0);
                  this.isClassAtom();
                ) {
                  var n = this.classAtom(), r = "Character" === n.type;
                  if (r && this.isRangeDash()) {
                    this.consumeChar("-");
                    var i = this.classAtom(), s = "Character" === i.type;
                    if (s) {
                      if (i.value < n.value) {
                ...
                if (void 0 !== t && this.input[this.idx] !== t) {
                  throw Error(
                    "Expected: '" + t + "' but found: '" +
                      this.input[this.idx] + "' at offset: " + this.idx,
                  );
                }
                if (this.idx >= this.input.length) {
            ...
            return h.prototype.visitChildren = function (t) {
              for (var e in t) {
                var n = t[e];
                t.hasOwnProperty(e) && (void 0 !== n.type
                  ? this.visit(n)
      ...
      e.defaultLexerErrorProvider = {
        buildUnableToPopLexerModeMessage: function (t) {
          return "Unable to pop Lexer Mode after encountering Token ->" +
            t.image + "<- The Mode Stack is empty";
        },
        buildUnexpectedCharactersMessage: function (t, e, n, r, i) {
          return "unexpected character: ->" + t.charAt(e) + "<- at offset: " +
            e + ", skipped " + n + " characters.";
        },
      };
  }, function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var r = n(0), i = n(1), o = n(8);
    function a(t) {
    ...
    function C(t, n, i) {
      switch (t.type) {
        ...
        case r.FLAT:
          return function (t, e, n) {
            var r = new a.Flat({ definition: [] }), i = P.exec(t.text)[1];
    ...
    function M(t, e, n, r, i) {
      var a = t.exec(n.text), s = void 0 === a[1];
    ...
    function F(t, n, r, i, a) {
      ...
      var l = new r({ definition: [], separator: p, idx: u }), h = s[2];
    ...
    function et(t) {
      var e = [];
      return o.forEach(t, function (t) {
        var n = it(t.text, r.FLAT, x, J), i = t.range.start;
        o.forEach(n, function (t) {
          t.range.start += i, t.range.end += i;
        }), e = e.concat(n);
      }),
        o.uniq(e, function (t) {
          return t.type + "~" + t.range.start + "~" + t.range.end + "~" +
            t.text;
        });
    }
    function nt(t, e, n) {
      for (var r, o = []; r = n.exec(t);) {
        var a = r.index, s = n.lastIndex, u = new i.Range(a, s), c = r[0];
    ...
    function st(t, e) {
      switch (t.type) {
        ...
        case "Option":
          return new a.Option(
            { name: t.name, idx: t.idx, definition: at(t.definition, e) },
          );
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var r = n(0), i = n(4), o = n(30), a = n(11), s = n(10), u = n(8);
    ...
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 });
    var r = n(2), i = n(0), o = n(6), a = n(22), s = n(4), u = n(3);
    function c(t) {
    ...
    var p = function () {
      ...
      return t.prototype.initRecoverable = function (t) {
        ...
        t.prototype.canPerformInRuleRecovery = function (t, e) {
          return this.canRecoverWithSingleTokenInsertion(t, e) ||
        ...
        t.prototype.reSyncTo = function (t) {
          for (
            var e = [], n = this.LA(1); !1 === this.tokenMatcher(n, t);
          ) {
    ...
    function l(t, e, n, i, o, a) {
      ...
      var p = u.token, l = u.occurrence, h = u.isEndOfRule;
    ...
    function h(t) {
      ...
      return {
        errors: u.map(e, function (t) {
          return {
            message: "Token Type: ->" + a.tokenName(t) +
    ...
    function f(t) {
      var e = u.filter(t, function (t) {
        var e = t[l];
        return !(u.isRegExp(e) || u.isFunction(e) || u.has(e, "exec") ||
          u.isString(e));
      });
      return {
        errors: u.map(e, function (t) {
    ...
    e.DEFAULT_MODE = "defaultMode",
      ...
      e.analyzeTokenTypes = function (t, n) {
        ...
        "onlyOffset" !== n.positionTracking && (y = u.map(r, function (t) {
          return u.has(t, "LINE_BREAKS") ? t.LINE_BREAKS : !1 === L(t, m)
          ...
          if ("string" == typeof e.PATTERN) {
            ...
            if (e.PATTERN.unicode) {
              A = !1,
                ...
                u.PRINT_ERROR(
                  c.failedOptimizationPrefixMsg + "\tUnable to analyze < " +
                    e.PATTERN.toString() +
            ...
            n.ensureOptimizations &&
            u.PRINT_ERROR(
              c.failedOptimizationPrefixMsg + "\tTokenType: <" +
                a.tokenName(e) +
      ...
      e.validatePatterns = function (t, e) {
        ...
        return n = (n = (n = (n = (n = n.concat(i.errors)).concat(function (t) {
          ...
          return e =
            (e = (e = (e = (e = e.concat(E(n))).concat(T(n))).concat(v(n)))
              .concat(g(n))).concat(m(n));
    ...
    function E(t) {
      var e = function (t) {
        ...
        n = u.filter(t, function (t) {
          var n = t[l];
          try {
            var r = p.pattern(n.toString()), i = new e();
    ...
    function g(t) {
      var e = [],
        n = u.map(t, function (n) {
          return u.reduce(t, function (t, r) {
            return n.PATTERN.source !== r.PATTERN.source || u.contains(e, r) ||
      ...
      return u.map(r, function (t) {
        ...
        return {
          message: "The same RegExp pattern ->" + u.first(t).PATTERN +
      ...
      return u.map(n, function (t) {
        return {
          message: "Token Type: ->" + a.tokenName(t) +
            ...
            t.PUSH_MODE + "<-which does not exist",
    ...
    function A(t) {
      var e = [],
        n = u.reduce(t, function (t, e, n) {
          var r, i = e.PATTERN;
          return i === s.Lexer.NA ? t : (u.isString(i)
      ...
      return u.forEach(t, function (t, r) {
        u.forEach(n, function (n) {
          var i = n.str, o = n.idx, c = n.tokenType;
          if (
            r < o && function (t, e) {
              if (u.isRegExp(e)) {
                var n = e.exec(t);
    ...
    e.findStartOfInputAnchor = T,
      ...
      e.performRuntimeChecks = function (t, n, r) {
        var i = [];
        return u.has(t, e.DEFAULT_MODE) ||
          i.push(
            {
              message: "A MultiMode Lexer cannot be initialized without a <" +
                e.DEFAULT_MODE + "> property in its definition\n",
              type:
          ...
          i.push(
            {
              message: "A MultiMode Lexer cannot be initialized without a <" +
                e.MODES + "> property in its definition\n",
              type:
                s.LexerDefinitionErrorType
                  .MULTI_MODE_LEXER_WITHOUT_MODES_PROPERTY,
            },
          ),
          u.has(t, e.MODES) && u.has(t, e.DEFAULT_MODE) &&
          !u.has(t.modes, t.defaultMode) &&
          i.push(
            {
              message: "A MultiMode Lexer cannot be initialized with a " +
                e.DEFAULT_MODE + ": <" + t.defaultMode +
    ...
    function h(t) {
      return !(!t.quantifier || 0 !== t.quantifier.atLeast) ||
    ...
    e.failedOptimizationPrefixMsg =
      ...
      e.getStartCodes = function (t, n) {
        void 0 === n && (n = !1);
        try {
          var r = s.pattern(t.toString()), i = c(r.value);
          return r.flags.ignoreCase && (i = p(i)), i;
        } catch (r) {
          if (r.message === u) {
            n &&
              a.PRINT_WARNING(
                e.failedOptimizationPrefixMsg + "\tUnable to optimize: < " +
                  t.toString() +
    ...
    e.canMatchCharCode = function (t, e) {
      if (e instanceof RegExp) {
        var n = s.pattern(e.toString()), r = new f(t);
        ...
        return t.prototype.initLooksAhead = function (t) {
          ...
          t.prototype.getLookaheadFuncForOr = function (t, e) {
            ...
            if (void 0 === o) {
              ...
              return o = r.buildLookaheadFuncForOr(
                t,
                u,
                this.maxLookahead,
                c,
          ...
          t.prototype.getLookaheadFuncFor = function (t, e, n, i) {
            ...
            if (void 0 === o) {
              ...
              return o = r.buildLookaheadFuncForOptionalProd(
                e,
                s,
                n,
                this.dynamicTokensEnabled,
      ...
      u = function () {
        ...
        return t.prototype.initTreeBuilder = function (t) {
          ...
          t.prototype.nestedRuleFinallyClause = function (t, e) {
            var n = this.CST_STACK, i = n[n.length - 1];
    ...
    function c(t, e) {
      var n = i.map(e, function (e) {
        if (!i.isFunction(t[e])) {
          return {
            msg: "Missing visitor method: <" + e + "> on " +
              o.functionName(t.constructor) + " CST Visitor.",
    ...
    e.defaultVisit = s,
      e.createBaseSemanticVisitorConstructor = function (t, e) {
        var n = function () {};
        return o.defineNameProp(n, t + "BaseSemantics"),
          (n.prototype = {
            visit: function (t, e) {
    ...
    function l(t, e) {
      var n = [];
      for (var s in t) {
        a.validTermsPattern.test(s) && i.isFunction(t[s]) &&
          !i.contains(p, s) && !i.contains(e, s) &&
          n.push(
            {
              msg: "Redundant visitor method: <" + s + "> on " +
        ...
        return t.prototype.initLexerAdapter = function () {
          ...
          t.prototype.SKIP_TOKEN = function () {
            return this.currIdx <= this.tokVector.length - 2
              ? (this.consumeToken(), this.LA(1)) : r.END_OF_FILE;
          },
        ...
        return t.prototype.CONSUME = function (t, e) {
          ...
          t.prototype.RULE = function (t, e, n) {
            if (
              ...
              var i = {
                message: a.defaultGrammarValidatorErrorProvider
    ...
    var r = n(0),
      ...
      f = function () {
        ...
        return t.prototype.initRecognizerEngine = function (t, e) {
          ...
          if (r.isArray(t)) {
            this.tokensMap = r.reduce(t, function (t, e) {
                ...
                function (t) {
                  try {
                    ...
                    if (o.isRecognitionException(t)) {
                      if (r) {
                        var i, a = this.findReSyncTokenType();
                        if (this.isInCurrentRuleReSyncSet(a)) {
                          return t.resyncedTokens = this.reSyncTo(a),
                            this.outputCst
                              ? ((i = this.CST_STACK[this.CST_STACK.length - 1])
                                .recoveredNode = !0,
                                i)
                              : c();
                        }
          ...
          t.prototype.optionInternalLogic = function (t, e, n) {
            var r, i, o = this, a = this.getLookaheadFuncForOption(n, e);
            if (void 0 !== t.DEF) {
          ...
          t.prototype.atLeastOneInternalLogic = function (t, e, n) {
            var r, o, u = this, c = this.getLookaheadFuncForAtLeastOne(n, t);
            if (void 0 !== e.DEF) {
          ...
          t.prototype.atLeastOneSepFirstInternalLogic = function (t, e, n) {
            var r = this, o = e.DEF, u = e.SEP;
            if (
              !0 !== this.getLookaheadFuncForAtLeastOneSep(n, t).call(this)
            ) {
              throw this.raiseEarlyExitException(
                t,
          ...
          t.prototype.manyInternalLogic = function (t, e, n) {
            var r, o, a = this, u = this.getLookaheadFuncForMany(n, t);
            if (void 0 !== e.DEF) {
              if (r = e.DEF, void 0 !== (o = e.GATE)) {
                var c = u;
                u = function () {
          ...
          t.prototype.orInternal = function (t, e) {
            ...
            try {
              ...
              if (void 0 !== s) {
                var u = a[s], c = this.nestedAltBeforeClause(u, e, i.OR_IDX, s);
                try {
            ...
            if (
              ...
              var t = this.LA(1),
                e = this.errorMessageProvider.buildNotAllInputParsedMessage(
                  { firstRedundant: t, ruleName: this.getCurrRuleFullName() },
                );
          ...
          t.prototype.consumeInternal = function (t, e, n) {
            ...
            try {
              ...
              if (!0 !== this.tokenMatcher(i, t)) {
                var a = void 0, s = this.LA(0);
                throw a = void 0 !== n && n.ERR_MSG
                  ? n.ERR_MSG
              ...
              if (
                ...
                "MismatchedTokenException" !== n.name || this.isBackTracking()
              ) {
                throw n;
              }
          ...
          t.prototype.raiseEarlyExitException = function (t, e, n) {
            for (
              var i = this.getCurrRuleFullName(),
                ...
                s =
                  o.getLookaheadPathsForOptionalProd(
                    t,
                    a,
                    e,
                    this.maxLookahead,
      ...
      o = function () {
        ...
        return t.prototype.initContentAssist = function () {},
          ...
          t.prototype.getNextPossibleTokenTypes = function (t) {
            var e = i.first(t.ruleStack), n = this.getGAstProductions().get(e);
    ...
    e.createSyntaxDiagramsCode = function (t, e) {
      ...
      return "\n\x3c!-- This is a generated file --\x3e\n<!DOCTYPE html>\n<meta charset=\"utf-8\">\n<style>\n  body {\n    background-color: hsl(30, 20%, 95%)\n  }\n</style>\n\n\n<link rel='stylesheet' href='" +
        (void 0 === a
          ? "https://unpkg.com/chevrotain@" + r.VERSION +
    ...
    function f(t, e) {
      var n = y(e, "{") + a;
      return t.name && (n += y(e + 1, 'NAME: "' + t.name + '",') + a),
    ...
    function d(t, e, n) {
      var r = y(n, "$." + (t + e.idx) + "(");
      return e.name || e.separator
        ? (r += "{" + a,
          e.name && (r += y(n + 1, 'NAME: "' + e.name + '"') + "," + a),
          e.separator &&
          (r += y(n + 1, "SEP: this.tokensMap." + i.tokenName(e.separator)) +
            "," + a),
