...
TWEEN.Group = _Group,
  ...
  "undefined" == typeof self && "undefined" != typeof process && process.hrtime
    ...
    : "undefined" != typeof self && void 0 !== self.performance &&
  ...
  TWEEN.Tween.prototype = {
    ...
    start: function (t) {
      for (
        var n in this._group.add(this),
          this._isPlaying = !0,
          this._onStartCallbackFired = !1,
          this._startTime = void 0 !== t
            ? "string" == typeof t ? TWEEN.now() + parseFloat(t) : t
            : TWEEN.now(),
    ...
    update: function (t) {
      ...
      for (
        n
          in !1 === this._onStartCallbackFired &&
      ...
      if (0 < this._repeat) {
        for (
          n in isFinite(this._repeat) && this._repeat--, this._valuesStartRepeat
        ) {
          if (
            "string" == typeof this._valuesEnd[n] &&
            (this._valuesStartRepeat[n] = this._valuesStartRepeat[n] +
              parseFloat(this._valuesEnd[n])), this._yoyo
          ) {
  ...
  TWEEN.Easing = {
    ...
    Elastic: {
      ...
      Out: function (t) {
        return 0 === t ? 0 : 1 === t
          ? 1
          : Math.pow(2, -10 * t) * Math.sin(5 * (t - .1) * Math.PI) + 1;
      },
      InOut: function (t) {
        return 0 === t
          ? 0
          ...
          ? 1
          : (t *= 2) < 1
          ? -.5 * Math.pow(2, 10 * (t - 1)) * Math.sin(5 * (t - 1.1) * Math.PI)
          : .5 * Math.pow(2, -10 * (t - 1)) *
              Math.sin(5 * (t - 1.1) * Math.PI) + 1;
      },
    },
    Back: {
      In: function (t) {
    ...
    Bounce: {
      ...
      Out: function (t) {
        ...
        : t < 2 / 2.75 ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : t < 2.5 / 2.75
          ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375
          : 7.5625 * (t -= 2.625 / 2.75) * t + .984375;
      },
      InOut: function (t) {
        return t < .5 ? .5 * TWEEN.Easing.Bounce.In(2 * t)
        : .5 * TWEEN.Easing.Bounce.Out(2 * t - 1) + .5;
      },
    },
  },
  TWEEN.Interpolation = {
    ...
    Utils: {
      ...
      CatmullRom: function (t, n, e, i, r) {
        ...
        return (2 * n - 2 * e + a + s) * (r * o) +
          (-3 * n + 3 * e - 2 * a - s) * o + a * r + n;
      },
    },
  },
  function (t) {
    ...
    : "undefined" != typeof module && "object" == typeof exports
      ? module.exports = TWEEN : void 0 !== t && (t.TWEEN = TWEEN);
  }(this);
export { TWEEN };
