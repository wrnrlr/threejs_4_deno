...
function colorToString(color, forceCSSHex) {
  ...
  if (
    forceCSSHex || colorFormat === "THREE_CHAR_HEX" ||
      ...
      THREE_CHAR_HEX: {
        read: function read(original) {
          ...
          return {
            space: "HEX",
            hex: parseInt(
              "0x" + test[1].toString() + test[1].toString() +
                test[2].toString() + test[2].toString() + test[3].toString() +
                test[3].toString(),
              0,
            ),
          };
  ...
  },
  {
    ...
    conversions: {
      RGBA_OBJ: {
        read: function read(original) {
          if (
            Common.isNumber(original.r) && Common.isNumber(original.g) &&
            Common.isNumber(original.b) && Common.isNumber(original.a)
          ) {
            return {
              space: "RGB",
              r: original.r,
      ...
      HSVA_OBJ: {
        read: function read(original) {
          if (
            Common.isNumber(original.h) && Common.isNumber(original.s) &&
            Common.isNumber(original.v) && Common.isNumber(original.a)
          ) {
            return {
              space: "HSV",
              h: original.h,
...
var interpret = function interpret() {
  toReturn = false;
  var original = arguments.length > 1
...
var ColorMath = {
  hsv_to_rgb: function hsv_to_rgb(h, s, v) {
    ...
    var t = v * (1.0 - (1.0 - f) * s);
    var c =
      [[v, t, p], [q, v, p], [p, v, t], [p, q, v], [t, p, v], [v, p, q]][hi];
    return {
      r: c[0] * 255,
      g: c[1] * 255,
      b: c[2] * 255,
  ...
  hex_with_component: function hex_with_component(hex, componentIndex, value) {
    return value << (tmpComponent = componentIndex * 8) |
...
var dom = {
  ...
  addClass: function addClass(elem, className) {
    if (elem.className === undefined) {
      ...
      if (classes.indexOf(className) === -1) {
        ...
        elem.className = classes.join(" ").replace(/^\s+/, "").replace(
          /\s+$/,
          "",
        );
      }
  ...
  getWidth: function getWidth(elem) {
    ...
    return cssValueToPixels(style["border-left-width"]) +
      ...
      cssValueToPixels(style["padding-right"]) + cssValueToPixels(style.width);
  },
  ...
  function NumberControllerBox(object, property, params) {
    ...
    var _this2 = possibleConstructorReturn(
      ...
      (NumberControllerBox.__proto__ ||
        Object.getPrototypeOf(NumberControllerBox)).call(
          this,
          object,
          property,
          params,
  ...
  function NumberControllerSlider(object, property, min, max, step) {
    ...
    var _this2 = possibleConstructorReturn(
      ...
      (NumberControllerSlider.__proto__ ||
        Object.getPrototypeOf(NumberControllerSlider)).call(
          this,
          object,
          property,
  ...
  function FunctionController(object, property, text) {
    ...
    var _this2 = possibleConstructorReturn(
      ...
      (FunctionController.__proto__ ||
        Object.getPrototypeOf(FunctionController)).call(this, object, property),
    );
    var _this = _this2;
...
var ColorController = function (_Controller) {
  ...
  function ColorController(object, property) {
    ...
    Common.extend(_this2.__field_knob.style, {
      ...
      width: "12px",
      height: "12px",
      border: _this2.__field_knob_border +
    ...
    function setSV(e) {
      ...
      var v = 1 -
        (clientY - fieldRect.top) / (fieldRect.bottom - fieldRect.top);
      if (v > 1) {
        v = 1;
      } else if (v < 0) {
        v = 0;
  ...
  createClass(ColorController, [{
    ...
    value: function updateDisplay() {
      ...
      Common.extend(this.__field_knob.style, {
        ...
        border: this.__field_knob_border + "rgb(" + flip + "," + flip + "," +
          flip + ")",
      });
      ...
      Common.extend(this.__input.style, {
        ...
        textShadow: this.__input_textShadow + "rgba(" + _flip + "," + _flip +
          "," + _flip + ",.7)",
      });
    },
  }]);
...
function linearGradient(elem, x, a, b) {
  ...
  Common.each(vendors, function (vendor) {
    elem.style.cssText += "background: " + vendor + "linear-gradient(" + x +
      ", " + a + " 0%, " + b + " 100%); ";
  });
}
  ...
  createClass(CenteredDiv, [{
    ...
    value: function layout() {
      this.domElement.style.left = window.innerWidth / 2 -
        dom.getWidth(this.domElement) / 2 + "px";
      this.domElement.style.top = window.innerHeight / 2 -
        dom.getHeight(this.domElement) / 2 + "px";
    },
  }]);
  return CenteredDiv;
}();
  ...
  onResize: function onResize() {
    ...
    if (root.scrollable) {
      ...
      if (window.innerHeight - top - CLOSE_BUTTON_HEIGHT < h) {
        ...
        root.__ul.style.height = window.innerHeight - top -
          CLOSE_BUTTON_HEIGHT + "px";
      } else {
...
function augmentController(gui, li, controller) {
  ...
  if (controller instanceof NumberControllerSlider) {
    ...
    var r = function r(returned) {
      if (
        Common.isNumber(controller.__min) && Common.isNumber(controller.__max)
      ) {
        var oldName =
