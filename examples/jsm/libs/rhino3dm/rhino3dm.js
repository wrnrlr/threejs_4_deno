    ...
    function (rhino3dm) {
      ...
      if (ENVIRONMENT_IS_NODE) {
        ...
        if (typeof print !== "undefined") {
          ...
          console.log = print;
          console.warn = console.error = typeof printErr !== "undefined"
            ? printErr
            : print;
        }
      ...
      function addFunctionWasm(func, sig) {
        ...
        var ret;
        if (freeTableIndexes.length) ret = freeTableIndexes.pop();
        else {
          ret = table.length;
          try {
            table.grow(1);
      ...
      var wasmTable = new WebAssembly.Table(
        { "initial": 6119, "maximum": 6119 + 0, "element": "anyfunc" },
      );
      var ABORT = false;
      var EXITSTATUS = 0;
      ...
      function stringToUTF32(str, outPtr, maxBytesToWrite) {
        ...
        for (var i = 0; i < str.length; ++i) {
          ...
          if (codeUnit >= 55296 && codeUnit <= 57343) {
            ...
            codeUnit = 65536 + ((codeUnit & 1023) << 10) |
              trailSurrogate & 1023;
          }
      ...
      var STACK_BASE = 5594832, DYNAMIC_BASE = 5594832, DYNAMICTOP_PTR = 351792;
      ...
      function ___cxa_throw(ptr, type, destructor) {
        ...
        } else __ZSt18uncaught_exceptionv.uncaught_exceptions++;
        throw ptr;
      }
        ...
        default_tty_ops: {
          get_char: function (tty) {
            if (!tty.input.length) {
              ...
              if (ENVIRONMENT_IS_NODE) {
                var BUFSIZE = 256;
                var buf = Buffer.alloc ? Buffer.alloc(BUFSIZE)
                : new Buffer(BUFSIZE);
                var bytesRead = 0;
                try {
                ...
                if (bytesRead > 0) {result = buf.slice(0, bytesRead).toString(
                    "utf-8",
                  );} else result = null;
              } else if (
      ...
      var MEMFS = {
        ...
        stream_ops: {
          ...
          llseek: function (stream, offset, whence) {
            ...
            else if (whence === 2) {if (FS.isFile(stream.node.mode)) {
      ...
      var FS = {
        ...
        nodePermissions: function (node, perms) {
          ...
          if (perms.indexOf("r") !== -1 && !(node.mode & 292)) return 2;
          else if (perms.indexOf("w") !== -1 && !(node.mode & 146)) return 2;
          else if (perms.indexOf("x") !== -1 && !(node.mode & 73)) return 2;
          return 0;
        },
        ...
        allocate: function (stream, offset, length) {
          ...
          if ((stream.flags & 2097155) === 0) throw new FS.ErrnoError(8);
          if (
            !FS.isFile(stream.node.mode) && !FS.isDir(stream.node.mode)
          ) {
        ...
        readFile: function (path, opts) {
          ...
          if (
            opts.encoding !== "utf8" && opts.encoding !== "binary"
          ) {
        ...
        forceLoadFile: function (obj) {
          if (
            obj.isDevice || obj.isFolder || obj.link || obj.contents
          ) {
            return true;
          }
          var success = true;
        ...
        createLazyFile: function (parent, name, url, canRead, canWrite) {
          ...
          stream_ops.read = function stream_ops_read(
            ...
            if (contents.slice) {
              ...
              for (var i = 0; i < size; i++) {buffer[offset + i] = contents.get(
                  position + i,
                );}
            }
            return size;
            ...
            return [{
              ...
              "toWireType": function (destructors, o) {
                if (elementsLength !== o.length) {
                  throw new TypeError(
                    "Incorrect number of tuple elements for " + reg.name +
                      ": expected=" + elementsLength + ", actual=" + o.length,
                  );
                }
      ...
      function embind__requireFunction(signature, rawFunction) {
        ...
        function makeDynCaller(dynCall) {
          ...
          var body = "return function " + name + "(" + args.join(", ") +
            ") {\n";
          body += "    return dynCall(rawFunction" + (args.length ? ", " : "") +
            args.join(", ") + ");\n";
          body += "};\n";
        ...
        whenDependentTypesAreResolved(
          ...
          function (base) {
            ...
            var constructor = createNamedFunction(
              ...
              function () {
                if (
                  Object.getPrototypeOf(this) !== instancePrototype
                ) {
      ...
      function validateThis(this_, classType, humanName) {
        ...
        if (
          !(this_ instanceof classType.registeredClass.constructor)
        ) {
          throwBindingError(
            humanName + ' incompatible with "this" of type ' +
              this_.constructor.name,
          );
        }
        if (!this_.$$.ptr) {
          throwBindingError(
            "cannot call emscripten binding method " + humanName +
              " on deleted object",
          );
        }
      ...
      function __embind_register_enum_value(rawEnumType, name, enumValue) {
        ...
        var Value = Object.create(
          enumType.constructor.prototype,
          {
        ...
        registerType(
          primitiveType,
          {
            ...
            "toWireType": function (destructors, value) {
              if (typeof value !== "number" && typeof value !== "boolean") {
                throw new TypeError(
                  'Cannot convert "' + _embind_repr(value) + '" to ' +
                    this.name,
                );
              }
              if (value < minRange || value > maxRange) {
                throw new TypeError(
                  'Passing a number "' + _embind_repr(value) +
                    '" from JS side to C/C++ side to an argument of type "' +
                    name + '", which is outside the valid range [' + minRange +
                    ", " + maxRange + "]!",
                );
              }
      ...
      function craftEmvalAllocator(argCount) {
        ...
        var functionBody = "return function emval_allocator_" + argCount +
          "(constructor, argTypes, args) {\n";
        for (var i = 0; i < argCount; ++i) {
          functionBody += "var argType" + i +
            " = requireRegisteredType(Module['HEAP32'][(argTypes >>> 2) + " +
            i + '], "parameter ' + i + '");\n' + "var arg" + i + " = argType" +
            i + ".readValueFromPointer(args);\n" + "args += argType" + i +
            "['argPackAdvance'];\n";
        }
      ...
      function getEnvStrings() {
        if (!getEnvStrings.strings) {
          var env = {
            ...
            "HOME": "/home/web_user",
            "LANG":
              (typeof navigator === "object" && navigator.languages &&
      ...
      var ___tm_current = 351808;
      var ___tm_timezone = (stringToUTF8("GMT", 351856, 4), 351856);
      ...
      function _uuid_generate(out) {
        ...
        if (ENVIRONMENT_IS_NODE) {
          ...
          ENVIRONMENT_IS_WEB && typeof window.crypto !== "undefined" &&
      ...
      var dynCall_vi = Module["dynCall_vi"] = function () {
        return (dynCall_vi = Module["dynCall_vi"] = Module["asm"]["dynCall_vi"])
          .apply(null, arguments);
      };
      var dynCall_ii = Module["dynCall_ii"] = function () {
        return (dynCall_ii = Module["dynCall_ii"] = Module["asm"]["dynCall_ii"])
          .apply(null, arguments);
      };
      var dynCall_i = Module["dynCall_i"] = function () {
        return (dynCall_i = Module["dynCall_i"] = Module["asm"]["dynCall_i"])
          .apply(null, arguments);
      };
      ...
      var dynCall_di = Module["dynCall_di"] = function () {
        return (dynCall_di = Module["dynCall_di"] = Module["asm"]["dynCall_di"])
          .apply(null, arguments);
      };
      ...
      var dynCall_iiidd = Module["dynCall_iiidd"] = function () {
        return (dynCall_iiidd = Module["dynCall_iiidd"] =
          Module["asm"]["dynCall_iiidd"]).apply(null, arguments);
      };
      ...
      var dynCall_iiiid = Module["dynCall_iiiid"] = function () {
        return (dynCall_iiiid = Module["dynCall_iiiid"] =
          Module["asm"]["dynCall_iiiid"]).apply(null, arguments);
      };
      var dynCall_iidddddd = Module["dynCall_iidddddd"] = function () {
        return (dynCall_iidddddd = Module["dynCall_iidddddd"] =
          Module["asm"]["dynCall_iidddddd"]).apply(null, arguments);
      };
      ...
      var dynCall_viddd = Module["dynCall_viddd"] = function () {
        return (dynCall_viddd = Module["dynCall_viddd"] =
          Module["asm"]["dynCall_viddd"]).apply(null, arguments);
      };
      var dynCall_viiddd = Module["dynCall_viiddd"] = function () {
        return (dynCall_viiddd = Module["dynCall_viiddd"] =
          Module["asm"]["dynCall_viiddd"]).apply(null, arguments);
      };
      var dynCall_iiiddd = Module["dynCall_iiiddd"] = function () {
        return (dynCall_iiiddd = Module["dynCall_iiiddd"] =
          Module["asm"]["dynCall_iiiddd"]).apply(null, arguments);
      };
      var dynCall_viiid = Module["dynCall_viiid"] = function () {
        return (dynCall_viiid = Module["dynCall_viiid"] =
          Module["asm"]["dynCall_viiid"]).apply(null, arguments);
      };
      ...
      var dynCall_did = Module["dynCall_did"] = function () {
        return (dynCall_did = Module["dynCall_did"] =
          Module["asm"]["dynCall_did"]).apply(null, arguments);
      };
      ...
      var dynCall_diiid = Module["dynCall_diiid"] = function () {
        return (dynCall_diiid = Module["dynCall_diiid"] =
          Module["asm"]["dynCall_diiid"]).apply(null, arguments);
      };
      var dynCall_iiiidd = Module["dynCall_iiiidd"] = function () {
        return (dynCall_iiiidd = Module["dynCall_iiiidd"] =
          Module["asm"]["dynCall_iiiidd"]).apply(null, arguments);
      };
      var dynCall_viidd = Module["dynCall_viidd"] = function () {
        return (dynCall_viidd = Module["dynCall_viidd"] =
          Module["asm"]["dynCall_viidd"]).apply(null, arguments);
      };
      var dynCall_iidid = Module["dynCall_iidid"] = function () {
        return (dynCall_iidid = Module["dynCall_iidid"] =
          Module["asm"]["dynCall_iidid"]).apply(null, arguments);
      };
      var dynCall_iiidid = Module["dynCall_iiidid"] = function () {
        return (dynCall_iiidid = Module["dynCall_iiidid"] =
          Module["asm"]["dynCall_iiidid"]).apply(null, arguments);
      };
      var dynCall_iiidddddd = Module["dynCall_iiidddddd"] = function () {
        return (dynCall_iiidddddd = Module["dynCall_iiidddddd"] =
          Module["asm"]["dynCall_iiidddddd"]).apply(null, arguments);
      };
      var dynCall_iiddd = Module["dynCall_iiddd"] = function () {
        return (dynCall_iiddd = Module["dynCall_iiddd"] =
          Module["asm"]["dynCall_iiddd"]).apply(null, arguments);
      };
      ...
      var dynCall_v = Module["dynCall_v"] = function () {
        return (dynCall_v = Module["dynCall_v"] = Module["asm"]["dynCall_v"])
          .apply(null, arguments);
      };
      ...
      var dynCall_iiiddiiidd = Module["dynCall_iiiddiiidd"] = function () {
        return (dynCall_iiiddiiidd = Module["dynCall_iiiddiiidd"] =
          Module["asm"]["dynCall_iiiddiiidd"]).apply(null, arguments);
      };
      var dynCall_iiididdddd = Module["dynCall_iiididdddd"] = function () {
        return (dynCall_iiididdddd = Module["dynCall_iiididdddd"] =
          Module["asm"]["dynCall_iiididdddd"]).apply(null, arguments);
      };
      var dynCall_iidiiiii = Module["dynCall_iidiiiii"] = function () {
        return (dynCall_iidiiiii = Module["dynCall_iidiiiii"] =
          Module["asm"]["dynCall_iidiiiii"]).apply(null, arguments);
      };
      ...
      var dynCall_iiiiddiiidd = Module["dynCall_iiiiddiiidd"] = function () {
        return (dynCall_iiiiddiiidd = Module["dynCall_iiiiddiiidd"] =
          Module["asm"]["dynCall_iiiiddiiidd"]).apply(null, arguments);
      };
      var dynCall_iiiddiddddd = Module["dynCall_iiiddiddddd"] = function () {
        return (dynCall_iiiddiddddd = Module["dynCall_iiiddiddddd"] =
          Module["asm"]["dynCall_iiiddiddddd"]).apply(null, arguments);
      };
      var dynCall_iiddiiiii = Module["dynCall_iiddiiiii"] = function () {
        return (dynCall_iiddiiiii = Module["dynCall_iiddiiiii"] =
          Module["asm"]["dynCall_iiddiiiii"]).apply(null, arguments);
      };
      var dynCall_iiddii = Module["dynCall_iiddii"] = function () {
        return (dynCall_iiddii = Module["dynCall_iiddii"] =
          Module["asm"]["dynCall_iiddii"]).apply(null, arguments);
      };
      var dynCall_iiiidiii = Module["dynCall_iiiidiii"] = function () {
        return (dynCall_iiiidiii = Module["dynCall_iiiidiii"] =
          Module["asm"]["dynCall_iiiidiii"]).apply(null, arguments);
      };
      var dynCall_iididii = Module["dynCall_iididii"] = function () {
        return (dynCall_iididii = Module["dynCall_iididii"] =
          Module["asm"]["dynCall_iididii"]).apply(null, arguments);
      };
