...
function ca(f) {
  var d = f.buffer, c, e = d.length, b = new (C ? Uint8Array : Array)(e << 1);
  if (C) b.set(d);
  else for (c = 0; c < e; ++c) b[c] = d[c];
  return f.buffer = b;
}
K.prototype.b = function (f, d, c) {
  var e = this.buffer, b = this.index, a = this.e, g = e[b], m;
  c && 1 < d &&
    (f = 8 < d
      ? (L[f & 255] << 24 | L[f >>> 8 & 255] << 16 | L[f >>> 16 & 255] << 8 |
        L[f >>> 24 & 255]) >> 32 - d
      : L[f] >> 8 - d);
...
K.prototype.finish = function () {
  var f = this.buffer, d = this.index, c;
  0 < this.e && (f[d] <<= 8 - this.e, f[d] = L[f[d]], d++);
  C ? c = f.subarray(0, d) : (f.length = d, c = f);
  return c;
};
var da = new (C ? Uint8Array : Array)(256), M;
for (M = 0; 256 > M; ++M) {
...
function ka(f, d) {
  ...
  d &&
    (d.lazy && (this.i = d.lazy),
      ...
      d.outputBuffer &&
      (this.a = C && d.outputBuffer instanceof Array
  ...
  switch (this.d) {
    case 0:
      ...
      for (e = b.length; c < e;) {
        ...
        if (C) {
          for (
            l = new Uint8Array(this.a.buffer); l.length <= h + a.length + 5;
          ) {
    ...
    case la:
      ...
      var Aa = [ua, X], Ba = [va, Y], I, Ca, $, ma, Da, Ea, Fa, Ga;
      Da = Aa[0];
      Ea = Aa[1];
      Fa = Ba[0];
      Ga = Ba[1];
...
var Ma = { NONE: V.NONE, FIXED: V.h, DYNAMIC: V.g }, Na, Oa, W, Pa;
